...
if(st.session_state.prediction > 0 ):        
    ...
    barplot_client_majority = Tools.barplot_client_majority(data, st.session_state.row[feats])
    barplot_same_clients = Tools.barplot_same_clients(data, st.session_state.row[feats])
    with col21:
